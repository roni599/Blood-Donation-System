...
public class SearchBloodDownerBloodGroup {
    JFrame frame;
    ImageIcon img;
    ResultSet result;
...
//        frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
    ...
    public void loadPanel(){
        ...
        sw.CreateLabel(240,30,1000,50,"Search Blood Downer(Blood)","Algerian",25);

        SwingModel sw1=new SwingModel();
        sw1.CreateLabel(305,70,150,50,"Blood Group:","Algerian",17);
        ...
        sw1.textField.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                String Blood_Group=sw1.textField.getText();
                String cmd;
                cmd="Select * from downer where Blood_group like '%"+Blood_Group+"%'";
